...
Import-Module "C:\Program Files\Delinea Software Ltd\RabbitMq Helper\net6.0-windows\Delinea.RabbitMq.Helper.PSCommands.dll" -Force ;
...
Set-ErlangCookieFileCommand -CookieContent 'SSOP_RMQ'
